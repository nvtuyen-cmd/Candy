...
//        ShowMenuButton("Tutorial", "Tutorial");
        ...
        private void GUIAds()
        {
            ...
            GUILayout.BeginHorizontal();
            GUILayout.Space(20);
            unityAdsSettings.unityRewardedAndroid = EditorGUILayout.TextField("Android rewarded ad unit ID",
                unityAdsSettings.unityRewardedAndroid, GUILayout.Width(320));

            GUILayout.EndHorizontal();
            GUILayout.BeginHorizontal();
            GUILayout.Space(20);
            unityAdsSettings.unityInterstitialAndroid = EditorGUILayout.TextField("Android interstitial ad unit ID",
                unityAdsSettings.unityInterstitialAndroid, GUILayout.Width(320));

            GUILayout.EndHorizontal();
            GUILayout.BeginHorizontal();
            GUILayout.Space(20);
            unityAdsSettings.unityRewardediOS = EditorGUILayout.TextField("iOS rewarded ad unit ID",
                unityAdsSettings.unityRewardediOS, GUILayout.Width(320));

            GUILayout.EndHorizontal();
            GUILayout.BeginHorizontal();
            GUILayout.Space(20);
            unityAdsSettings.unityInterstitialiOS = EditorGUILayout.TextField("iOS interstitial ad unit ID",
                unityAdsSettings.unityInterstitialiOS, GUILayout.Width(320));
