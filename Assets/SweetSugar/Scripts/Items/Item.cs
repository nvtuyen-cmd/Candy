...
//            sprRenderer.FirstOrDefault().sortingOrder = 2;
        ...
        private void Update()
        {
            ...
            if(!falling && square && LevelManager.GetGameStatus() != GameState.RegenLevel && field == LevelManager.THIS.field && usedItem != this && usedItemSecond != this && NextType == ItemsTypes.NONE)
                CheckSquareBelow();
        }
